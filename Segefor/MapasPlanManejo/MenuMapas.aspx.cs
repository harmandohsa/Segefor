...
namespace SEGEFOR.MapasPlanManejo
{
    public partial class MenuMapas : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                int TipoMapa = Convert.ToInt32(Request.QueryString["typecarte"]);
                TxtTipoMapa.Value = TipoMapa.ToString();
                ver_mapas();
                mapas();
                informacion(TipoMapa);
                puntos_poligono(TipoMapa);
            }
        }
        ...
        protected void btnelimina_Click(object sender, EventArgs e)
        {
            ...
            Txtnopoligono.Value = "";
            mapas();
            informacion(Convert.ToInt32(TxtTipoMapa.Value));
            puntos_poligono(Convert.ToInt32(TxtTipoMapa.Value));
        }
        ...
        private void informacion(int TipoMapa)
        {
            ...
            if (TipoMapa == 1)
            {
                Comando = new SqlCommand("sp_Lee_poligonos_inmueble", cn);
            ...
            cn2.Open();
            SqlCommand Comando2 = new SqlCommand("", cn);
            if (TipoMapa == 1)
            {
                Comando2 = new SqlCommand("sp_Lee_poligonos2inmueble", cn);
                Comando2.CommandType = CommandType.StoredProcedure;
                Comando2.Parameters.Add("@InmuebleId", SqlDbType.Int, 1);
                Comando2.Parameters["@InmuebleId"].Value = Id;
            }
        ...
        private void puntos_poligono(int TipoMapa)
        {
            ...
            if (TipoMapa == 1)
            {
                Comando = new SqlCommand("sp_obtener_puntos_poligonos_Inmueble", cn);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@InmuebleId", SqlDbType.Int, 1);
                Comando.Parameters["@InmuebleId"].Value = Id;
            }
