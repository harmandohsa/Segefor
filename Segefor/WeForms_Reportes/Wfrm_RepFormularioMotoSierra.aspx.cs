...
{
    public partial class Wfrm_RepFormularioMotoSierra : System.Web.UI.Page
    {
        ...
        Rpt_FormularioMotoSierra Reporte = new Rpt_FormularioMotoSierra();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet Ds_Formulario_MotoSierra = new DataSet();
            Ds_Formulario_MotoSierra = ((DataSet)Session["Ds_MotoSierra"]);
            Reporte.PrintOptions.PaperOrientation = PaperOrientation.Portrait;
            Reporte.SetDataSource((DataSet)Ds_Formulario_MotoSierra);

            string llamada = ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["appel"].ToString()), true);
            string NomReporte;
            if (llamada == "1")
                NomReporte = Ds_Formulario_MotoSierra.Tables["Ds_MotoSierra"].Rows[0]["NUG"] + ".pdf";
            else
