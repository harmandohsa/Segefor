...
{
    public partial class Wfrm_RepSolCompletacionGestion : System.Web.UI.Page
    {
        ...
        Rpt_SolicitudCompletacionGestion Reporte = new Rpt_SolicitudCompletacionGestion();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ds = ClGestion.ImpresionGestionInCompleta(Convert.ToInt32(ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["gestion"].ToString()), true)), Convert.ToInt32(ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["subcategoria"].ToString()), true)));
