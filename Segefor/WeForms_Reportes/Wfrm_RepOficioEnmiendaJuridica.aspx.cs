...
{
    public partial class Wfrm_RepOficioEnmiendaJuridica : System.Web.UI.Page
    {
        ...
        Rpt_Oficio_Enmiendas_Juridico Reporte = new Rpt_Oficio_Enmiendas_Juridico();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet Ds_Providencia = new DataSet();
            Ds_Providencia = ((DataSet)Session["DatosOficioEnmiendasJuridico"]);

            Reporte.PrintOptions.PaperOrientation = PaperOrientation.Portrait;
            Reporte.SetDataSource(Ds_Providencia);
