...
{
    public partial class Wfrm_RepDictamenSubRegional : System.Web.UI.Page
    {
        ...
        Rpt_Dictamen_SubRegional Reporte = new Rpt_Dictamen_SubRegional();


        protected void Page_Load(object sender, EventArgs e)
        {
            DataSet Ds_DictamenSubRegional = new DataSet();
            Ds_DictamenSubRegional = ((DataSet)Session["DatosDictamenSubRegion"]);


            Reporte.PrintOptions.PaperOrientation = PaperOrientation.Portrait;
            Reporte.SetDataSource(Ds_DictamenSubRegional);
