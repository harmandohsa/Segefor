...
{
    public partial class Wfrm_RepFormularioSistemasAgroforestales : System.Web.UI.Page
    {
        ...
        Rpt_FormularioSistemasAgro Reporte = new Rpt_FormularioSistemasAgro();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet Ds_Formulario_SistemaAgroforestal = new DataSet();
            Ds_Formulario_SistemaAgroforestal = ((DataSet)Session["Ds_Formulario_SistemaAgroforestal"]);
            Reporte.PrintOptions.PaperOrientation = PaperOrientation.Portrait;
            Reporte.SetDataSource((DataSet)Ds_Formulario_SistemaAgroforestal);
            ...
            {
                string[] GestionId = Ds_Formulario_SistemaAgroforestal.Tables["Dt_Plantacion_SistemaAgroforestal"].Rows[0]["NUG"].ToString().Split('-');
            ...
            string NomReporte;
            if (llamada == "1")
                NomReporte = Ds_Formulario_SistemaAgroforestal.Tables["Ds_Formulario_SistemaAgroforestal"].Rows[0]["NUG"] + ".pdf";
            else
            ...
            //if (llamada == "1")
            //{
            //    string Mensaje = "Su solicitud fue enviada exitosamente, con Numero Único de Gestión (NUG): " + Ds_Formulario_SistemaAgroforestal.Tables["Ds_Formulario_SistemaAgroforestal"].Rows[0]["NUG"] + ". Por lo que solicitamos presentarse a la oficina Subregional " + Ds_Formulario_SistemaAgroforestal.Tables["Ds_Formulario_SistemaAgroforestal"].Rows[0]["SubRegion"] + ", con la documentación que deberá presentar para dar trámite a su solicitud.";
