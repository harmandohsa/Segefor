...
{
    public partial class Wfrm_RepFormularioFuenteSemillera : System.Web.UI.Page
    {
        ...
        Rpt_FormularioFuentesSemilleras Reporte = new Rpt_FormularioFuentesSemilleras();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataSet Ds_Formulario_FuenteSemillera = new DataSet();
            Ds_Formulario_FuenteSemillera = ((DataSet)Session["Ds_Formulario_FuenteSemillera"]);
            Reporte.PrintOptions.PaperOrientation = PaperOrientation.Portrait;
            Reporte.SetDataSource((DataSet)Ds_Formulario_FuenteSemillera);
            ...
            {
                string[] GestionId = Ds_Formulario_FuenteSemillera.Tables["Dt_Fueste_Semillera"].Rows[0]["NUG"].ToString().Split('-');
            ...
            string NomReporte;
            if (llamada == "1")
                NomReporte = Ds_Formulario_FuenteSemillera.Tables["Ds_Formulario_FuenteSemillera"].Rows[0]["NUG"] + ".pdf";
            else
            ...
            //if (llamada == "1")
            //{
            //    string Mensaje = "Su solicitud fue enviada exitosamente, con Numero Único de Gestión (NUG): " + Ds_Formulario_FuenteSemillera.Tables["Ds_Formulario_FuenteSemillera"].Rows[0]["NUG"] + ". Por lo que solicitamos presentarse a la oficina Subregional " + Ds_Formulario_FuenteSemillera.Tables["Ds_Formulario_FuenteSemillera"].Rows[0]["SubRegion"] + ", con la documentación que deberá presentar para dar trámite a su solicitud.";
