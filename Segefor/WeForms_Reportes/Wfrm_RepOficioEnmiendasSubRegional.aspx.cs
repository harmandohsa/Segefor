...
{
    public partial class Wfrm_RepOficioEnmiendasSubRegional : System.Web.UI.Page
    {
        ...
        Rpt_OficioEnmiendasSubRegional Reporte = new Rpt_OficioEnmiendasSubRegional();


        protected void Page_Load(object sender, EventArgs e)
        {
            DataSet Ds_EnmiendasTecnico = new DataSet();
            Ds_EnmiendasTecnico = ((DataSet)Session["DatosEnmiendaSubRegion"]);


            Reporte.PrintOptions.PaperOrientation = PaperOrientation.Portrait;
            Reporte.SetDataSource(Ds_EnmiendasTecnico);
            Reporte.Subreports[0].SetDataSource(Ds_EnmiendasTecnico);
