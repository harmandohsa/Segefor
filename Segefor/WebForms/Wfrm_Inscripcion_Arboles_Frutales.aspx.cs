...
{
    public partial class Wfrm_Inscripcion_Arboles_Frutales : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ClUsuario.Insertar_Ingreso_Pagina(38, Convert.ToInt32(Session["UsuarioId"]), ClUsuario.CorrId_IngresoPagina());
                ...
                DataSet dsPermisos = ClUsuario.Get_Roles(Convert.ToInt32(Session["UsuarioId"]), 38);
                ...
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoSubCategoriasRegistro(3, Convert.ToInt32(Session["PersonaId"])), CboTipoPlantacion, "SubCategoriaId", "Nombre_Subcategoria");
        ...
        void BtnYes_Click(object sender, EventArgs e)
        {
            ...
            ClGestionRegistro.Insertar_Gestion_ArbolFrutal(GestionId, Convert.ToInt32(CboTipoPlantacion.SelectedValue), 3, TxtDireccionNotifica.Text, Convert.ToInt32(CboMunicipio.SelectedValue), Telefono, Convert.ToInt32(TxtCelularNotifica.Text.Replace("-", "")), TxtCorreoNotifica.Text, TxtObservaciones.Text, TxtNomFirma.Text, Convert.ToInt32(Session["UsuarioId"]));
            ...
            //Session["Ds_Formulario_Plantacion_Voluntaria"] = ClGestionRegistro.ImpresionFormularioPlantacionVoluntaria(GestionId,2);
        ...
        bool Valida()
        {
            ...
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe ingresar el polígono de la platación";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe ingresar el polígono de la platación";
                HayError = true;
            }
