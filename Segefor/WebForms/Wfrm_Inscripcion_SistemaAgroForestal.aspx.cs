...
{
    public partial class Wfrm_Inscripcion_SistemaAgroForestal : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CboCategoriaSAF.SelectedIndexChanged += CboCategoriaSAF_SelectedIndexChanged;
            ChkSinIncentivo.CheckedChanged += ChkSinIncentivo_CheckedChanged;
            ...
            else if (!IsPostBack)
            {
                ...
                ClUtilitarios.LlenaCombo(ClCatalogos.Listado_CategoriaSAF(), CboCategoriaSAF, "CategoriaSAFId", "CategoriaSAF");
                ClUtilitarios.AgregarSeleccioneCombo(CboCategoriaSAF, "Sub Categoría");
        ...
        {
            if ((Convert.ToInt32(CboTipoPlantacion.SelectedValue) == 35) || (Convert.ToInt32(CboTipoPlantacion.SelectedValue) == 34) || (Convert.ToInt32(CboTipoPlantacion.SelectedValue) == 43) || (Convert.ToInt32(CboTipoPlantacion.SelectedValue) == 42))
            {
                DivDatosInv.Visible = true;
                LblValor.InnerText = "Area Total (Ha)";
            }
            else if ((Convert.ToInt32(CboTipoPlantacion.SelectedValue) == 40) || (Convert.ToInt32(CboTipoPlantacion.SelectedValue) == 41))
            {
                DivDatosInv.Visible = true;
                LblValor.InnerText = "Metros Lineales";
            }
            else
                DivDatosInv.Visible = false;
            TxtNombreSistema.Text = CboTipoPlantacion.Text;
        }

        void ChkSinIncentivo_CheckedChanged(object sender, EventArgs e)
        {
            if (ChkSinIncentivo.Checked == true)
            {
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoProcedencia(5), CboProcedencia, "ProcedenciaId", "Procedencia");
                ClUtilitarios.AgregarSeleccioneCombo(CboProcedencia, "Procedencia");
                ChkConIncentivos.Checked = false;
            }
        }

        void CboCategoriaSAF_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ClUtilitarios.LlenaCombo(ClCatalogos.ListadoSubCategoriasRegistro(4, Convert.ToInt32(Session["PersonaId"]),Convert.ToInt32(CboCategoriaSAF.SelectedValue)), CboTipoPlantacion, "SubCategoriaId", "Nombre_Subcategoria");
            if ((Convert.ToInt32(CboCategoriaSAF.SelectedValue) == 1) || (Convert.ToInt32(CboCategoriaSAF.SelectedValue) == 2))
            {
            ...
            else
            {
                ...
                TxtNombreSistema.Text = CboTipoPlantacion.SelectedItem.Text;
                DivDatosInv.Visible = true;
                LblValor.InnerText = "Area Total (Ha)";
            }
        ...
        bool ValidaEspecie()
        {
            ...
            if ((TxtDistancia.Text == "") || (TxtDistancia.Text == "0"))
            {
                if (LblMensajeEspecie.Text == "")
                    LblMensajeEspecie.Text = LblMensajeEspecie.Text + "Debe ingresar el distanciamiento";
                else
                    LblMensajeEspecie.Text = LblMensajeEspecie.Text + ", debe ingresar el distanciamiento";
                HayError = true;
            }
        ...
        void BtnYes_Click(object sender, EventArgs e)
        {
            ...
            if (CboProcedencia.SelectedValue != "")
                ProcedenciaId = Convert.ToInt32(CboProcedencia.SelectedValue);
            int Telefono = 0;
            if (TxtTelefonoNotifica.Text != "")
                Telefono = Convert.ToInt32(TxtTelefonoNotifica.Text.Replace("-", ""));
            ClGestionRegistro.Insertar_Gestion_SistemaAgro(GestionId, Convert.ToInt32(CboTipoPlantacion.SelectedValue), 4, Convert.ToInt32(ClUtilitarios.IIf(ChkConIncentivos.Checked == true, 1, 0)), ProcedenciaId, Convert.ToInt32(CboCategoriaSAF.SelectedValue),  TxtDireccionNotifica.Text, Convert.ToInt32(CboMunicipio.SelectedValue), Telefono, Convert.ToInt32(TxtCelularNotifica.Text.Replace("-", "")), TxtCorreoNotifica.Text, TxtObservaciones.Text, TxtNomFirma.Text, Convert.ToInt32(Session["UsuarioId"]));
            ...
            if (GrdInventario.Items.Count > 0)
            {
                ...
                for (int i = 0; i < GrdInventario.Items.Count; i++)
                {
                    ...
                    ClXml.AgregarAtributo("Distancia", GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Distancia"], iElementoDetalle);
                    iElementos.AppendChild(iElementoDetalle);
                ...
                if (TxtValor.Visible == false)
                    ...
                    ClGestionRegistro.Insert_Inventario_Forestal(GestionId, iInformacion, Convert.ToInt32(Session["UsuarioId"]), TxtNombreSistema.Text,Convert.ToDouble(TxtValor.Text));
            }
        ...
        void VistaPrevia()
        {
            ...
            row["CategoriaSAF"] = CboCategoriaSAF.Text;
            row["TipoPlantacion"] = CboTipoPlantacion.Text;
            if (ChkConIncentivos.Checked == true)
                row["Incentivos"] = "Con Incentivos";
            if (ChkSinIncentivo.Checked == true)
                row["Incentivos"] = "Sin Incentivos";
            if (CboProcedencia.SelectedValue == "")
                row["Procedencia"] = "";
            else
            ...
            Session["Ds_Formulario_SistemaAgroforestal"] = Ds_Formulario_SistemaAgroforestal;
            RadWindow1.Title = "Vista Previa Insripción";
            RadWindow1.NavigateUrl = "~/WeForms_Reportes/Wfrm_RepFormularioSistemasAgroforestales.aspx?appel=" + HttpUtility.UrlEncode(ClUtilitarios.Encrypt("0", true)) + "";
        ...
        bool Valida()
        {
            ...
            if ((CboCategoriaSAF.Text == "") || (CboCategoriaSAF.SelectedValue == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((ChkSinIncentivo.Checked == false) && (ChkConIncentivos.Checked == false))
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar si es con o sin incentivos";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar si es con o sin incentivos";
                HayError = true;
            }
            if ((ChkConIncentivos.Checked== true) && ((CboProcedencia.Text == "") || (CboProcedencia.SelectedValue == "")))
            {
                if (LblMensaje.Text == "")
            ...
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar el departamento de notifiçación";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar el departamento de notifiçación";
                HayError = true;
            }
            ...
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar el municipio de notifiçación";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar el municipio de notifiçación";
                HayError = true;
            }
            ...
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe ingresar el polígono";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe ingresar el polígono";
                HayError = true;
            }
        ...
        void ChkConIncentivos_CheckedChanged(object sender, EventArgs e)
        {
            if (ChkConIncentivos.Checked == true)
            {
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoProcedencia(4), CboProcedencia, "ProcedenciaId", "Procedencia");
                ClUtilitarios.AgregarSeleccioneCombo(CboProcedencia, "Procedencia");
                ChkSinIncentivo.Checked = false;
            }
            else
            {
                //ClUtilitarios.LlenaCombo(ClCatalogos.ListadoProcedencia(1), CboProcedencia, "ProcedenciaId", "Procedencia");
                //ClUtilitarios.AgregarSeleccioneCombo(CboProcedencia, "Procedencia");
                //ChkConIncentivos.Checked = true;
            }
        }
        ...
        void AgregaEspecie()
        {
            ...
            rowNew["Distancia"] = TxtDistancia.Text;
