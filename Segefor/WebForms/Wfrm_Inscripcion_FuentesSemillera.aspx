<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="Wfrm_Inscripcion_FuentesSemillera.aspx.cs" Inherits="SEGEFOR.WebForms.Wfrm_Inscripcion_FuentesSemillera" %>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2><strong>FORMULARIO PARA INSCRIPCIÓN DE FUENTES SEMILLERAS Y DE MATERIAL VEGETATIVO</strong></h2>
                            </div>
                        </div>
                        ...
                        <div class="ibox-content">
                            <h3><strong>I.  TIPO DE FUENTE SEMILLERA Y MATERIAL VEGETATIVO</strong></h3>
                        </div>
                        <div class="ibox-content">
                             <div><label class="col-sm-2 control-label centradolabel">Sub Categoría:</label>
                                <div class="col-sm-8"><telerik:RadComboBox ID="CboCategoriaSF" AutoPostBack="true" Width="100%" runat="server"></telerik:RadComboBox></div>
                            </div>
                        </div>
                        <div class="ibox-content">
                        ...
                        <div runat="server" id="DivUsosAreas" visible="false">
                            ...
                            <div class="ibox-content" runat="server" id="Div2">
                                <h3>Área destinada para la Fuente</h3>
                                <div><label class="col-sm-1 control-label centradolabel">Área Fuente Semillera(ha):</label>
                                    <div class="col-sm-2"><asp:TextBox runat="server" ID="TxtAreaFuente" step="any" min="0"  type="number"  CssClass="form-control" required=""></asp:TextBox></div>
                                </div>
                            </div>
                            <div class="ibox-content">
                            <div class="col-sm-5">
                                        ...
                                        <div class="panel-body">
                                            <div class="panel-group" id="accordion3">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h5 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion3" href="#collapseOne3">Especies arboreas</a>
                                                        </h5>
                                                    </div>
                                                    <div id="collapseOne3" class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                            ...
                                                            <div class="col-sm-5">
                                                                <telerik:RadComboBox ID="CboEspecieArb" AllowCustomText="true" Filter="Contains"  Width="100%" runat="server"></telerik:RadComboBox>	
                                                            </div>
                                                            <div class="col-sm-2">
                                                                <a class="btn btn-primary m-b" runat="server" id="BtnAddEspecieArb">Agregar Especie</a>
                                                            </div>
                                                        </div>
                                                        <div class="panel-body">
                                                            <telerik:RadGrid runat="server" ID="GrdEspeciesArb" Skin="Telerik"
                                                                AutoGenerateColumns="false" Width="100%" AllowSorting="true"  
                                                                GridLines="Both" PageSize="20" >
                                                                <PagerStyle Mode="NumericPages" NextPageText="Siguiente" 
                                                                    PrevPageText="Anterior" Position="Bottom" 
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="ibox-content">
                                                                <div class="col-sm-9">
                                                                    <div class="alert  alert-success alert-dismissable" runat="server" id="DivErrEspecieArb" visible="false">
                                                                        <button runat="server" aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                                                        <asp:Label runat="server" ID="LblErrEspecieArb" Font-Bold="true">Error</asp:Label>
                                                                    </div>
                                                                </div>
                                                                <div style="padding-bottom:2em;"></div>
                                                                </div>
                        ...
                        <div class="ibox-content">
                             <div><label class="col-sm-2 control-label centradolabel">Procedencia:</label>
                                <div class="col-sm-4"><telerik:RadComboBox ID="CboProcedencia" Width="100%" runat="server"></telerik:RadComboBox></div>
                            </div>
                            <div><label class="col-sm-2 control-label centradolabel">Tipo de Bosque:</label>
                                <div class="col-sm-4"><telerik:RadComboBox ID="CboTipoBosque" Width="100%" runat="server"></telerik:RadComboBox></div>
                            </div>
                        </div>
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox float-e-margins">
                                            ...
                                            <div class="panel-group" id="accordion">
                                                <div class="panel panel-default">
                                                    ...
                                                    <div id="collapseOne" class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                            <div id="DivDatosInv" runat="server" visible="false">
                                                                <label id="LblValor" runat="server" class="col-sm-3 control-label">Especie</label>
                                                                <div class="col-sm-2">
                                                                    <asp:TextBox runat="server" ID="TxtValor" step="any" type="number" min="0"  CssClass="form-control"></asp:TextBox>	
                                                                </div>
                                                            </div>
                                                        </div>
                                                         <div class="panel-body">
                                                            <div>
                                                                <label class="col-sm-3 control-label">Nombre Fuente Semillera y de Material Vegetativo:</label>
                                                                <div class="col-sm-5">
                                                                    <asp:TextBox runat="server" ID="TxtNombreSistema"  CssClass="form-control"></asp:TextBox>	
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="panel-body">
                                                            <div>
                                                                ...
                                                                <label class="col-sm-1 control-label">Cantidad Arboles</label>
                                                                <div class="col-sm-2">
                                                                     <asp:TextBox runat="server" ID="TxtCantArboles" step="any" type="number" min="0"  CssClass="form-control"></asp:TextBox>	
                                                                </div>
                                                        ...
                                                        <div class="panel-body">
                                                            <div>
                                                                ...
                                                                <label class="col-sm-2 control-label">Altura promedio</label>
                                                                <div class="col-sm-2">
                                                        ...
                                                        <div class="panel-body">
                                                            <telerik:RadGrid runat="server" ID="GrdInventario" Skin="Telerik"
                                                                ...
                                                                <PagerStyle Mode="NumericPages" NextPageText="Siguiente" 
                                                                    ...
                                                                    PagerTextFormat="Change page: {4} &amp;nbsp;Pagina &lt;strong&gt;{0}&lt;/strong&gt; de &lt;strong&gt;{1}&lt;/strong&gt;, registros &lt;strong&gt;{2}&lt;/strong&gt; a &lt;strong&gt;{3}&lt;/strong&gt; de &lt;strong&gt;{5}&lt;/strong&gt;." 
                                                                    PageSizeLabelText="Regitros"/>
                                                                <MasterTableView Name="LabelsInventario" Caption="" DataKeyNames="EspecieId,Especie,CntArboles,Dap,Altura,YearEst" NoMasterRecordsText="No Hay Registros" ShowFooter="true">
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="CntArboles" UniqueName="CntArboles" HeaderText="Cantidad de Arboles" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
