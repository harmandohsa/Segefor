<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="Wfrm_Inscripcion_BosqueNatural.aspx.cs" Inherits="SEGEFOR.WebForms.Wfrm_Inscripcion_BosqueNatural" %>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2><strong>FORMULARIO PARA INSCRIPCIÓN  DE BOSQUES NATURALES</strong></h2>
                            </div>
                        </div>
                        <div class="ibox-content">
                            <div><label class="col-sm-3 control-label centradolabel">Solicitud de:</label>
                                <div class="col-sm-7"><h3><asp:Label runat="server" ID="LblSolicitante"></asp:Label></h3></div>
                            </div>
                        </div>
                        <div class="ibox-content">
                        ...
                        <div class="ibox-content">
                             <div>
                                <div class="col-sm-3"><asp:CheckBox runat="server"  ID="ChkConIncentivos" AutoPostBack="true" Visible="true" Text="¿Con Incentivos?." /></div>
                            </div>
                        </div>
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content" runat="server" id="DivProcedencia">
                             <div><label class="col-sm-2 control-label centradolabel">Procedencia:</label>
                                <div class="col-sm-8"><telerik:RadComboBox ID="CboProcedencia"  Width="100%" runat="server"></telerik:RadComboBox></div>
                            </div>
                        </div>
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <div><label class="col-sm-1 control-label centradolabel">X:</label>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="TxtUbicacionOeste" step="5  " min="0" type="number" CssClass="form-control" required=""></asp:TextBox>
                                </div>
                            </div>
                            <div><label class="col-sm-1 control-label centradolabel">Y:</label>
                                <div class="col-sm-4">
                                    <asp:TextBox runat="server" ID="TxtUbicacionNorte" step="5" min="0" type="number" CssClass="form-control" required=""></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div style="padding-bottom:2em;"></div>
                        ...
                        <div style="padding-bottom:2em;"></div>
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="collapseOne5" class="panel-collapse collapse out">
                                                            <div class="panel-body">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <a class="btn btn-primary m-b" runat="server" id="BtnCargarPolFinca">Cargar</a>
                                                                </div>
                                                            </div>
                                                            <div class="panel-body">
                            ...
                            <div class="ibox-content">
                                <div class="col-sm-5">
                                    <a class="btn btn-primary m-b" runat="server" id="btnGrabarFinca">Grabar Finca</a>
                                </div>
                            </div>
                            <div class="ibox-content">
                                <div class="col-sm-8">
                                        ...
                                        <div class="panel-body">
                                            <div class="panel-group" id="accordion">
                                                <div class="panel panel-default">
                                                    <div class="panel-heading">
                                                        <h5 class="panel-title">
                                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Ingreso de Datos del Bosque</a>
                                                        </h5>
                                                    </div>
                                                    <div id="collapseOne" class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                            <div>
                                                                <label class="col-sm-2 centradolabel control-label">Tipo de Bosque</label>
                                                                <div class="col-sm-5">
                                                                    <telerik:RadComboBox ID="CboTipoBosque" AutoPostBack="true"  Width="100%" runat="server"></telerik:RadComboBox>	
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="panel-body">
                                                            <div>
                                                                <label class="col-sm-1 centradolabel control-label">Rodal</label>
                                                                <div class="col-sm-2">
                                                                    <asp:TextBox runat="server" ID="TxtRodal" step="any" type="number" min="0"  CssClass="form-control"></asp:TextBox>
                                                                </div>
                                                                <div runat="server" id="DivClaseDesarrollo">
                                                                    <label class="col-sm-3 centradolabel control-label">Clase de Desarrollo</label>
                                                                    <div class="col-sm-4">
                                                                    <telerik:RadComboBox ID="CboClaseDesarrollo"  Width="100%" runat="server"></telerik:RadComboBox>	
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="panel-body">
                                                            <div>
                                                                <label class="col-sm-1 control-label centradolabel">Especie</label>
                                                                <div class="col-sm-5">
                                                                    <telerik:RadComboBox ID="CboEspecie"  Width="100%" runat="server"></telerik:RadComboBox>	
                                                                </div>
                                                                <label class="col-sm-3 control-label centradolabel">Densidad/ha Promedio</label>
                                                                <div class="col-sm-2">
                                                        ...
                                                        <div class="panel-body">
                                                            <label class="col-sm-2 control-label centradolabel">Altura comercial (m) Promedio</label>
                                                            <div class="col-sm-2">
                                                                <asp:TextBox runat="server" ID="TxtAltura" step="any" type="number" min="0"  CssClass="form-control"></asp:TextBox>	
                                                            </div>
                                                            <div id="DivEstrato" runat="server" visible="false">
                                                                <label class="col-sm-1 control-label centradolabel">Estrato</label>
                                                                <div class="col-sm-3">
                                                                <telerik:RadComboBox ID="CboEstrato"  Width="100%" runat="server"></telerik:RadComboBox>	
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="panel-body">
                                                            <telerik:RadGrid runat="server" ID="GrdInventario" Skin="Telerik"
                                                                ...
                                                                <PagerStyle Mode="NumericPages" NextPageText="Siguiente" 
                                                                    ...
                                                                    PagerTextFormat="Change page: {4} &amp;nbsp;Pagina &lt;strong&gt;{0}&lt;/strong&gt; de &lt;strong&gt;{1}&lt;/strong&gt;, registros &lt;strong&gt;{2}&lt;/strong&gt; a &lt;strong&gt;{3}&lt;/strong&gt; de &lt;strong&gt;{5}&lt;/strong&gt;." 
                                                                    PageSizeLabelText="Regitros"/>
                                                                <MasterTableView Name="LabelsInventario" Caption="" DataKeyNames="Rodal,ClaseDesarrolloId,ClaseDesarrollo,EspecieId,Especie,NomCientificoEspecie,Densidad,Area,Edad,Dap,Altura,EstratoId,Estrato" NoMasterRecordsText="No Hay Registros" ShowFooter="true">
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="ClaseDesarrolloId" Visible="false" UniqueName="Especie" HeaderText="EspecieId" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="ClaseDesarrollo" UniqueName="Especie" HeaderText="Clase Desarrollo" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="NomCientificoEspecie" UniqueName="NomCientificoEspecie" HeaderText="Nombre Cientifico" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="Densidad" UniqueName="Densidad" HeaderText="Densidad /ha   Promedio" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="Area" UniqueName="Area" HeaderText="Área Badal  (m 2)/Promedio" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="Edad" UniqueName="Edad" HeaderText="Edad (años) Promedio" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="Altura" UniqueName="Altura" HeaderText="Altura comercial (m) Promedio" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="EstratoId" Visible="false" UniqueName="EstratoId" HeaderText="EstratoId" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                                        <telerik:GridBoundColumn DataField="Estrato" UniqueName="Estrato" Visible="false" HeaderText="Estrato" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
