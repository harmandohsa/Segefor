...
{
    public partial class Wfrm_Inscripcion_Motosierras : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TxtFecVenc.SelectedDate = DateTime.Now;
            ...
            CboSubRegion.SelectedIndexChanged += CboSubRegion_SelectedIndexChanged;
            ...
            {
                ClUsuario.Insertar_Ingreso_Pagina(43, Convert.ToInt32(Session["UsuarioId"]), ClUsuario.CorrId_IngresoPagina());
                ...
                DataSet dsPermisos = ClUsuario.Get_Roles(Convert.ToInt32(Session["UsuarioId"]), 43);
                ...
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoSubCategoriasRegistro(9, Convert.ToInt32(Session["PersonaId"])), CboSubCategoria, "SubCategoriaId", "Nombre_Subcategoria");
                ...
                ClUtilitarios.AgregarSeleccioneCombo(CboDe, "Empresa Mercantil");
                ...
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoTipoDoc_Juridico(), CboTipoDocumento, "TipoDocumentoId", "TipoDocumento");
        ...
        void DesbloqueaDatosEmpresa()
        {
            ...
            TxtStockMotoSierra.Enabled = true;
        }
        ...
        void BloqueaDatosEmpresa()
        {
            ...
            TxtStockMotoSierra.Enabled = false;
        }
        ...
        void CboRegion_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
        ...
        void CboSubRegion_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            
            if (CboRegion.SelectedValue != "")
                TxtSubRegionId.Text = CboSubRegion.SelectedValue;
        }

        void CboTipoDocumento_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            if ((CboTipoDocumento.SelectedValue == "1") || (CboTipoDocumento.SelectedValue == "4"))
            {
                Div_DatEmpresa.Visible = true;
                Div_DatFactura.Visible = true;
                Div_DatEspecifique.Visible = false;
            }
            else if (CboTipoDocumento.SelectedValue == "5")
            {
                Div_DatEmpresa.Visible = false;
                Div_DatFactura.Visible = false;
                Div_DatEspecifique.Visible = true;
            }
            else
            {
                Div_DatEmpresa.Visible = false;
        ...
        {
            if (Convert.ToInt32(CboSubCategoria.SelectedValue) == 15)
            {
                Div_Comercializadora.Visible = true;
                Div_Motosierra.Visible = false;
                DivActividadPrincipal.Visible = true;
                Div_RegionComercializadora.Visible = true;
                Div_RegionMoto.Visible = false;
            }
            else
            {
                Div_Comercializadora.Visible = false;
                Div_Motosierra.Visible = true;
                DivActividadPrincipal.Visible = false;
                Div_RegionComercializadora.Visible = false;
                Div_RegionMoto.Visible = true;
            }

            if (CboEmpresa.SelectedValue != "")
            {
                bool Resul = false;
                if (CboSubCategoria.SelectedValue != "15")
                {
                    Resul = ClGestionRegistro.Existe_Tipo_Gestion(Convert.ToInt32(Session["PersonaId"]), 9, Convert.ToInt32(CboSubCategoria.SelectedValue), 0, Convert.ToInt32(CboEmpresa.SelectedValue), 0);
                    if (Resul == true)
                    {
                        BtnEnviar.Visible = false;
                        BtnVistaPrevia.Visible = false;
        ...
        void BtnYes_Click(object sender, EventArgs e)
        {
            ...
            if (CboSubCategoria.SelectedValue == "15")
            {
                ActividadPrincipalId = Convert.ToInt32(CboActividadPrincipal.SelectedValue);
            }
            if (CboSubCategoria.SelectedValue == "11")
            {
                Modelo = TxtModelo.Text;
                Cilindraje = Convert.ToDouble(TxtCilindraje.Text);
                Potencia = Convert.ToDouble(TxtPotencia.Text);
                TipoDocumentoId = Convert.ToInt32(CboTipoDocumento.SelectedValue);
                
            }
            ClGestionRegistro.Insertar_Gestion_MotoSierra(GestionId, Convert.ToInt32(CboSubCategoria.SelectedValue), 9, EmpresaId, TxtMarca.Text, Modelo, Cilindraje, Potencia, TxtNoSerie.Text, TipoDocumentoId, TxtNoFactura.Text, TxtEmpresa.Text, TxtEspecifique.Text, TxtNombreEmpresaSocial.Text, ActividadPrincipalId, TxtDireccionNotifica.Text, Convert.ToInt32(CboMunicipio.SelectedValue), Telefono, Convert.ToInt32(TxtCelularNotifica.Text.Replace("-", "")), TxtCorreoNotifica.Text, TxtObservaciones.Text, TxtNomFirma.Text, Convert.ToInt32(Session["UsuarioId"]), Convert.ToInt32(CboTipoPersona.SelectedValue));
            if (CboSubCategoria.SelectedValue == "15")
            {
                ClGestionRegistro.Insert_DatosEmpresa_Gestion(GestionId, Convert.ToInt32(TxtHorasTurno.Text), Convert.ToInt32(TxtEmplFijo.Text), Convert.ToInt32(TxtEmplNoFijo.Text), Convert.ToInt32(TxtDiasYear.Text), Convert.ToInt32(TxtStockMotoSierra.Text));
                ClEmpresa.Actualiza_DatosEmpresa(EmpresaId, Convert.ToInt32(TxtHorasTurno.Text), Convert.ToInt32(TxtEmplFijo.Text), Convert.ToInt32(TxtEmplNoFijo.Text), Convert.ToInt32(TxtDiasYear.Text), Convert.ToInt32(TxtStockMotoSierra.Text));
            }
        ...
        void VistaPrevia()
        {
            ...
            if (CboSubCategoria.SelectedValue == "11")
            {
                ...
                if ((GrdPropietarios.Items.Count > 0) && (GrdRepresentantes.Items.Count == 0))
            ...
            else
            {
                ...
                Requisitos++;
                if ((Convert.ToInt32(CboTipoPersona.SelectedValue) == 1) && (GrdPropietarios.Items.Count > 0))
                {
                    row["Requisitos"] = row["Requisitos"] + "\n " + Requisitos + ") Copia del documento personal de identificación del propietario.";
                    Requisitos++;
                }

                if ((Convert.ToInt32(CboTipoPersona.SelectedValue) == 2) || (GrdRepresentantes.Items.Count > 0))
                {
            ...
            row["SubCategoriaRNF"] = CboSubCategoria.Text;
            ...
            row["TurnoHoras"] = TxtHorasTurno.Text;
            row["DiasYear"] = TxtDiasYear.Text;
            row["StockMotoSierra"] = TxtStockMotoSierra.Text;
            row["NoEmplAdmin"] = TxtEmplFijo.Text;
            row["NoEmplOper"] = TxtEmplNoFijo.Text;
            ...
            row["Cilindraje"] = TxtCilindraje.Text;
            row["Potencia"] = TxtPotencia.Text;
            row["NoSerie"] = TxtNoSerie.Text;
            row["TipoDocumento"] = CboTipoDocumento.Text;
            if ((CboTipoDocumento.SelectedValue == "1") || (CboTipoDocumento.SelectedValue == "4"))
            {
                row["NoFactura"] = TxtNoFactura.Text;
                row["DeEmpresa"] = TxtEmpresa.Text;
            }
            else
            {
                row["NoFactura"] = "--------------";
            ...
            if (CboTipoDocumento.SelectedValue == "5")
                row["Especifique"] = TxtEspecifique.Text;
            else
                row["Especifique"] = "--------------";
            ...
            row["SubCategoriaId"] = CboSubCategoria.SelectedValue;
            Ds_Formulario_MotoSierra.Tables["Dt_MotoSierra"].Rows.Add(row);
            if (CboTipoPersona.SelectedValue == "1")
            {
                Ds_Formulario_MotoSierra.Tables["Dt_Propietarios"].Clear();
                for (int i = 0; i < GrdPropietarios.Items.Count; i++)
                {
            ...
            if (GrdRepresentantes.Items.Count > 0)
            {
                ...
                for (int i = 0; i < GrdRepresentantes.Items.Count; i++)
                {
                    DataRow rowRepresentantes = Ds_Formulario_MotoSierra.Tables["Dt_Representantes"].NewRow();
                    ...
                    Ds_Formulario_MotoSierra.Tables["Dt_Representantes"].Rows.Add(rowRepresentantes);
                }
            }
            Session["Ds_MotoSierra"] = Ds_Formulario_MotoSierra;
        ...
        bool Valida()
        {
            ...
            if ((CboSubCategoria.SelectedValue == "11") && ((CboRegion.Text == "") || (CboRegion.SelectedValue == "")))
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar la región de la gestión";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar la región de la gestión";
                HayError = true;
            }
            if ((CboSubCategoria.SelectedValue == "11") && ((CboSubRegion.Text == "") || (CboSubRegion.SelectedValue == "")))
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar la sub-región de la gestión";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar la sub-región de la gestión";
                HayError = true;
            }
            if ((CboSubCategoria.SelectedValue == "15") && (TxtNombreComercial.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtNIT.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtNoMercantil.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtFolio.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtLibro.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && ((CboDe.Text == "") || (CboDe.SelectedValue == "")))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && ((CboCategoria.Text == "") || (CboCategoria.SelectedValue == "")))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtObjeto.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtHorasTurno.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtDiasYear.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtEmplFijo.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtEmplNoFijo.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtDireccion.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && ((CboDepEmpresa.SelectedValue == "") || (CboDepEmpresa.SelectedValue == "0")))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && ((CboMunEmpresa.SelectedValue == "") || (CboMunEmpresa.SelectedValue == "0")))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtTelUnoEmpresa.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtCorreoEmpresa.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "11") && ((CboTipoDocumento.SelectedValue == "") || (CboTipoDocumento.SelectedValue == "0")))
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar el tipo de documento";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar el tipo de documento";
                HayError = true;
            }
            ...
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "Debe seleccionar el tipo de propietario";
                else
                    LblMensaje.Text = LblMensaje.Text + ", debe seleccionar el tipo de propietario";
                HayError = true;
            }
            if ((CboTipoPersona.SelectedValue != "") && (CboTipoPersona.SelectedValue == "6") && (TxtNombreEmpresaSocial.Text == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "15") && (TxtEmpresaId.Text == "") && (ClEmpresa.Existe_Empresa(Convert.ToInt32(TxtNoMercantil.Text), Convert.ToInt32(TxtFolio.Text), Convert.ToInt32(TxtLibro.Text), Convert.ToInt32(CboDe.SelectedValue)) == true))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboTipoPersona.SelectedValue != "") && (CboTipoPersona.SelectedValue == "7") && (GrdPropietarios.Items.Count == 0))
            {
                if (LblMensaje.Text == "")
            ...
            if ((CboSubCategoria.SelectedValue == "11") && (ClGestionRegistro.Existe_Serie_MotoSierra(TxtNoSerie.Text) == true))
            {
                if (LblMensaje.Text == "")
                    LblMensaje.Text = LblMensaje.Text + "El número de serie ya existe para otra motosierra";
                else
                    LblMensaje.Text = LblMensaje.Text + ", el número de serie ya existe para otra motosierra";
                HayError = true;
            }
            if ((CboSubCategoria.SelectedValue == "15") && ((CboActividadPrincipal.SelectedValue == "") || (CboActividadPrincipal.SelectedValue == "0")))
            {
                if (LblMensaje.Text == "")
        ...
        void CargaInfo(int EmpresaId)
        {
            ...
            if (dsEmpresa.Tables["DATOS"].Rows[0]["StockMotosierra"].ToString() != "")
                TxtStockMotoSierra.Text = dsEmpresa.Tables["DATOS"].Rows[0]["StockMotosierra"].ToString();
