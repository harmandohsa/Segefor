                        ...
                        <div runat="server" id="DivOpcionesINAB" visible="true">
                            <div class="ibox-content">
                                ...
                                <telerik:RadTabStrip id="RadTabStrip1" SelectedIndex="0" runat="server" MultiPageID="RadMultiPage1" Skin="Silk">
                                    <Tabs>
                                        <telerik:RadTab runat="server" Text="Registro Nacional Forestal" Selected="true"></telerik:RadTab> <%--0--%>
                                        <telerik:RadTab runat="server" Text="Licencias Forestales"></telerik:RadTab> <%--1--%>
                                    </Tabs>
                                </telerik:RadTabStrip>
                                <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" > 

                                    <telerik:RadPageView ID="RadPageRegistro" runat="server"> <%--Registro Forestal--%>
                                        <div class="ibox-title">
                                    ...
                                    <telerik:RadPageView ID="RadPageView1" runat="server"> <%--Manejo Forestal--%>
                                        ...
                                        <div class="ibox-content">
                                            ...
                                            <PagerStyle Mode="NumericPages" NextPageText="Siguiente" 
                                                ...
                                                PagerTextFormat="Change page: {4} &amp;nbsp;Pagina &lt;strong&gt;{0}&lt;/strong&gt; de &lt;strong&gt;{1}&lt;/strong&gt;, registros &lt;strong&gt;{2}&lt;/strong&gt; a &lt;strong&gt;{3}&lt;/strong&gt; de &lt;strong&gt;{5}&lt;/strong&gt;." 
                                                PageSizeLabelText="Regitros"/>
                                                <MasterTableView Caption="" DataKeyNames="GestionId,No_Resolucion,No_Dictamen_Juridico,No_Providencia,No_Expediente,Fecha_Exp,NUG,Fecha,nombres,EstatusGestion,ModuloId,dpi,SubCategoria" NoMasterRecordsText="No Hay Registros" ShowFooter="true">
                                                    <Columns>
                                                        <telerik:GridBoundColumn DataField="GestionId" UniqueName="RegionId" Visible="false"  HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="ModuloId" UniqueName="ModuloId" Visible="false" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
                                                        <telerik:GridTemplateColumn HeaderText="LIcencia Forestal" ShowFilterIcon="false" AllowFiltering="false" HeaderTooltip="Click para ver documento" Visible="true" UniqueName="Reg_RNF" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="LnkLicenciaForestal" Font-Underline="true"  CommandName="DocLicencia" formnovalidate ToolTip="Clic para ver documento"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn> 
                                                        <telerik:GridTemplateColumn HeaderText="No. de Dictamen SubRegional" ShowFilterIcon="false" AllowFiltering="false" HeaderTooltip="Click para ver documento" Visible="true" UniqueName="Reg_RNF" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="LnkDictamenSubRegional" Font-Underline="true"  CommandName="DocDictamenSubReg" formnovalidate ToolTip="Clic para ver documento"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn> 
                                                        <telerik:GridTemplateColumn HeaderText="No. de Dictamen Técnico" ShowFilterIcon="false" AllowFiltering="false" HeaderTooltip="Click para ver documento" Visible="true" UniqueName="Reg_RNF" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="LnkDictamenTecnico" Font-Underline="true"  CommandName="DocDictamenTec" formnovalidate ToolTip="Clic para ver documento"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn> 
                                                        <telerik:GridTemplateColumn HeaderText="No. Oficio Devolución." ShowFilterIcon="false" AllowFiltering="false" HeaderTooltip="Click para ver documento" Visible="true" UniqueName="No_Oficio_Dev" ItemStyle-HorizontalAlign="Left">
                                                            <ItemTemplate>
                                                        ...
                                                        <telerik:GridBoundColumn DataField="nombres" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"  UniqueName="nombres" HeaderText="Solicitante" HeaderStyle-Width="200px"></telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="dpi" AutoPostBackOnFilter="true" CurrentFilterFunction="Contains"  UniqueName="dpi" HeaderText="No. Identificación" HeaderStyle-Width="200px"></telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="SubCategoria" UniqueName="actividad" ShowFilterIcon="false" AllowFiltering="false" HeaderText="Actividad" HeaderStyle-Width="300px"></telerik:GridBoundColumn>
                                                        <telerik:GridBoundColumn DataField="EstatusGestion" ShowFilterIcon="false" AllowFiltering="false" UniqueName="estatus" HeaderText="Estatus" HeaderStyle-Width="300px"></telerik:GridBoundColumn>
                                                        <telerik:GridTemplateColumn HeaderText="Ver Solicitud" ShowFilterIcon="false" AllowFiltering="false" Visible="true" UniqueName="Seg" ItemStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:ImageButton runat="server" ID="ImgVerinfo" ImageUrl="~/Imagenes/24x24/pdf.png" formnovalidate ToolTip="Ver Información" CommandName="CmdVer"/>
