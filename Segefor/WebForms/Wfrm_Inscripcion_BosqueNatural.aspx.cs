...
{
    public partial class Wfrm_Inscripcion_BosqueNatural : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            CboTipoBosque.SelectedIndexChanged += CboTipoBosque_SelectedIndexChanged;
            ...
            else if (!IsPostBack)
            {
                ...
                TxtUsuarioId.Text = ClUsuario.Get_UsuarioId_Persona(Convert.ToInt32(ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["personneid"].ToString()), true))).ToString();
                ClGestionRegistro.Eliminar_Datos_Temp_Registro(Convert.ToInt32(TxtUsuarioId.Text));
                TxtPersonaId.Text = ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["personneid"].ToString()), true);
                ClUtilitarios.LlenaCombo(ClGestionRegistro.Inmuebles_GetAll_Registro(Convert.ToInt32(TxtUsuarioId.Text)), CboFinca, "InmuebleId", "Finca");
                ClUtilitarios.AgregarSeleccioneCombo(CboFinca, "Finca/Inmueble");
                if (CboFinca.Items.Count > 1)
                    BtnAddFincaPlan.Visible = true;
                DataSet dsPersona = ClPersona.Datos_Persona(Convert.ToInt32(ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["personneid"].ToString()), true)));
                ...
                LblSolicitante.Text =  ClPersona.Nombre_Usuario(Convert.ToInt32(ClUtilitarios.Decrypt(HttpUtility.UrlDecode(Request.QueryString["personneid"].ToString()), true)));
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoProcedencia(8), CboProcedencia, "ProcedenciaId", "Procedencia");
                ...
                ClUtilitarios.AgregarSeleccioneCombo(CboClaseDesarrollo, "Clase Desarrollo");
                ClUtilitarios.LlenaCombo(ClCatalogos.Listado_Estrato(), CboEstrato, "EstratoId", "Estrato");
                ClUtilitarios.AgregarSeleccioneCombo(CboEstrato, "Estrato");
                
            }
        }

        void CboTipoBosque_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            Ds_Temporal.Tables["Dt_Bosque"].Clear();
            GrdInventario.Rebind();
            if (CboTipoBosque.SelectedValue == "2")
            {
                DivEstrato.Visible = true;
                DivClaseDesarrollo.Visible = false;
                GrdInventario.Columns[2].Visible = false;
                GrdInventario.Columns[12].Visible = true;
            }
            else
            {
                DivEstrato.Visible = false;
                DivClaseDesarrollo.Visible = true;
                GrdInventario.Columns[2].Visible = true;
                GrdInventario.Columns[12].Visible = false;
            }
        }
        ...
        void BtnValidarPasaporteRep_ServerClick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    DatosPersona = ClPersona.Datos_Persona(Convert.ToInt32(TxtPersonaId.Text));
        ...
        void GrabarAreas()
        {
            ...
            else
            {
                ...
                ClGestionRegistro.Insertar_AreasInmuebleRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text), Convert.ToDouble(ClUtilitarios.IIf(TxtAreaForestal.Text == "", 0, TxtAreaForestal.Text)));
        ...
        void GrdPropietarios_ItemCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "CmdDel")
            {
                ClGestionRegistro.Elimina_PropietarioFinca_Registro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text), Convert.ToInt32(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["PersonaId"]));
        ...
        {
            ClGestionRegistro.ActualizarNombre_EmpresaTempFincaRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text), TxtNombreEmpresaSocial.Text, TxtNit.Text);
        }
        ...
        void AgregarPropietarioAlPlan(int Existe, int PersonaId, string Nombres, string Apellidos, DateTime FecVence, int PaisId, string Dpi, int Origen_Persona)
        {
            ...
            ClGestionRegistro.InsertTempFincaPropietarioRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text), PersonaId);
        ...
        void CboTipoPersona_SelectedIndexChanged(object sender, RadComboBoxSelectedIndexChangedEventArgs e)
        {
            ...
            ClGestionRegistro.ActualizarTipoPersonaTempFincaRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text), Convert.ToInt32(CboTipoPersona.SelectedValue));
        }
        ...
        void GrdInmuebles_ItemCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "CmdDel")
            {
                ClGestionRegistro.Eliminar_AreasInmuebleRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["InmuebleId"]));
                ClGestionRegistro.EliminarTempPropietariosRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["InmuebleId"]));
                ClGestionRegistro.EliminarTempFincaRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["InmuebleId"]));
            ...
            if (e.CommandName == "CmdPropietarios")
            {
                ...
                PropietariosYaExistentes(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text));
                GrdPropietarios.Rebind();
                DataSet dsTipoPersona = ClGestionRegistro.GetTipoPersonaTempRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text));
        ...
        void RetornoAreas()
        {
            DataSet dsDatosAreas = ClGestionRegistro.GetAreasFinca_Registro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text));
        ...
        void AgregarFincaGestion()
        {
            ...
            {
                ClGestionRegistro.InsertTempFincaGestionRegistro(Convert.ToInt32(CboFinca.SelectedValue), Convert.ToInt32(TxtUsuarioId.Text));
        ...
        {
            ClUtilitarios.LlenaGrid(ClGestionRegistro.Get_TempFincaRegistro(Convert.ToInt32(TxtUsuarioId.Text)), GrdInmuebles);
        }
        ...
        bool ValidaFinca()
        {
            ...
            if ((TxtFecEmi.DateInput.Text != "") && (CboMunicipio.SelectedValue != "") && (CboTipoDocumento.SelectedValue != "") && (ClInmueble.Existe_Propiedad_Usuario(Convert.ToInt32(TxtUsuarioId.Text), TxtDirccion.Text, TxtAldea.Text, TxtFinca.Text, Convert.ToInt32(CboMunicipio.SelectedValue), Convert.ToInt32(CboTipoDocumento.SelectedValue), Convert.ToDateTime(TxtFecEmi.SelectedDate), Convert.ToInt32(ClUtilitarios.IIf(TxtNoFinca.Text == "", 0, TxtNoFinca.Text)), Convert.ToInt32(ClUtilitarios.IIf(TxtFolio.Text == "", 0, TxtFolio.Text)), Convert.ToInt32(ClUtilitarios.IIf(TxtLibro.Text == "", 0, TxtLibro.Text)), TxtDe.Text, TxtNoCerti.Text, TxtMunEmiteDoc.Text, TxtNoEscritura.Text, Convert.ToInt32(CboTitulo.SelectedValue), TxtNomNotario.Text, Convert.ToInt32(OptAreasPro.SelectedValue), AreaId, Convert.ToDecimal(TxtAreaFinca.Text)) == true))
            {
                if (LblErrFinca.Text == "")
            ...
            if ((TxtFecEmi.DateInput.Text != "") && (CboMunicipio.SelectedValue != "") && (CboTipoDocumento.SelectedValue != "") && (ClInmueble.Existe_Propiedad_OtroUsuario(Convert.ToInt32(TxtUsuarioId.Text), TxtDirccion.Text, TxtAldea.Text, TxtFinca.Text, Convert.ToInt32(CboMunicipio.SelectedValue), Convert.ToInt32(CboTipoDocumento.SelectedValue), Convert.ToDateTime(TxtFecEmi.SelectedDate), Convert.ToInt32(ClUtilitarios.IIf(TxtNoFinca.Text == "", 0, TxtNoFinca.Text)), Convert.ToInt32(ClUtilitarios.IIf(TxtFolio.Text == "", 0, TxtFolio.Text)), Convert.ToInt32(ClUtilitarios.IIf(TxtLibro.Text == "", 0, TxtLibro.Text)), TxtDe.Text, TxtNoCerti.Text, TxtMunEmiteDoc.Text, TxtNoEscritura.Text, Convert.ToInt32(CboTitulo.SelectedValue), TxtNomNotario.Text, Convert.ToInt32(OptAreasPro.SelectedValue), AreaId, Convert.ToDecimal(TxtAreaFinca.Text)) == true))
            {
                if (LblErrFinca.Text == "")
        ...
        void Grabar()
        {
            if (ValidaFinca() == true)
            {
                ...
                if (GraboFinca == true)
                {
                    ClGestionRegistro.InsertTempFincaGestionRegistro(InmuebleId, Convert.ToInt32(TxtUsuarioId.Text));
                    GrdInmuebles.Rebind();
                    DivGoodFinca.Visible = true;
        ...
        void btnGrabarFinca_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                ClGestionRegistro.EliminarTempPropietariosRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text));
                ClGestionRegistro.Eliminar_AreasInmuebleRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text));
                ClGestionRegistro.EliminarTempFincaRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(TxtInmuebleId.Text));
        ...
        void GrdInventario_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "CmdDel")
            {
                EliminarEspecie(Convert.ToInt32(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["Rodal"].ToString()), Convert.ToInt32(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["EspecieId"].ToString()), Convert.ToDouble(e.Item.OwnerTableView.DataKeyValues[e.Item.ItemIndex]["Densidad"]));
            }
        }

        void EliminarEspecie(int Rodal, int EspecieId, double densidad)
        {
            for (int i = 0; i < GrdInventario.Items.Count; i++)
            {
                if ((Rodal == Convert.ToInt32(GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Rodal"])) && (EspecieId == Convert.ToInt32(GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["EspecieId"])) && (densidad == Convert.ToInt32(GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Densidad"])))
                {

                }
                else
                {
                    DataRow rowNew = Ds_Temporal.Tables["Dt_Bosque"].NewRow();
                    rowNew["Rodal"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Rodal"];
                    rowNew["ClaseDesarrolloId"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["ClaseDesarrolloId"];
                    rowNew["ClaseDesarrollo"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["ClaseDesarrollo"];
                    ...
                    rowNew["NomCientificoEspecie"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["NomCientificoEspecie"];
                    ...
                    rowNew["Edad"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Edad"];
                    ...
                    rowNew["EstratoId"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["EstratoId"];
                    rowNew["Estrato"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Estrato"];
                    Ds_Temporal.Tables["Dt_Bosque"].Rows.Add(rowNew);
                }
            }
            dv = Ds_Temporal.Tables["Dt_Bosque"].DefaultView;
            dv.Sort = "Rodal ASC";
            GrdInventario.Rebind();
        }
        ...
        bool ValidaEspecie()
        {
            ...
            if ((CboTipoBosque.SelectedValue != "2") && ((CboClaseDesarrollo.Text == "") || (CboClaseDesarrollo.SelectedValue == "")))
            {
                if (LblMensajeEspecie.Text == "")
                    LblMensajeEspecie.Text = LblMensajeEspecie.Text + "Debe seleccionar clase de desarrollo";
                else
                    LblMensajeEspecie.Text = LblMensajeEspecie.Text + ", debe seleccionar clase de desarrollo";
                HayError = true;
            }
            ...
            {
                if (LblMensajeEspecie.Text == "")
                    LblMensajeEspecie.Text = LblMensajeEspecie.Text + "Debe seleccionar un estrato";
                else
                    LblMensajeEspecie.Text = LblMensajeEspecie.Text + ", debe seleccionar un estrato";
                HayError = true;
            }
        ...
        void btnAddEspecie_ServerClick(object sender, EventArgs e)
        {
            ...
            {
                //if ((SumaAreasRodales() + Convert.ToDouble(TxtArea.Text) > ClGestionRegistro.GetSumaAreasForestalesTempFincaRegistro(Convert.ToInt32(TxtUsuarioId.Text))))
                //{
                //    DivErrEspecie.Visible = true;
        ...
        void BtnYes_Click(object sender, EventArgs e)
        {
            ...
            ClGestionRegistro.Insertar_Gestion(GestionId, NUG, Convert.ToInt32(TxtPersonaId.Text), Convert.ToInt32(TxtSubRegionId.Text), 13, 3, Correlativo_Anual);
            ...
            if (ChkConIncentivos.Checked == true)
                ConIncentivos = 1;
            ClGestionRegistro.Gestion_BosqueNatural_Insert(GestionId,14, 1,ConIncentivos, Procedencia, TxtDireccionNotifica.Text, Convert.ToInt32(CboMunicipio.SelectedValue), Telefono, Convert.ToInt32(TxtCelularNotifica.Text.Replace("-", "")), TxtCorreoNotifica.Text, TxtObservaciones.Text, TxtNomFirma.Text, Convert.ToInt32(Session["UsuarioId"]),Convert.ToInt32(CboTipoBosque.SelectedValue));
            ClGestionRegistro.GrabarFincasRegistro(GestionId, Convert.ToInt32(TxtUsuarioId.Text));
            for (int i = 0; i < GrdRepresentantes.Items.Count; i++)
            {
            ...
            if (GrdInventario.Items.Count > 0)
            {
                ...
                for (int i = 0; i < GrdInventario.Items.Count; i++)
                {
                    ...
                    ClXml.AgregarAtributo("ClaseDesarrolloId", GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["ClaseDesarrolloId"], iElementoDetalle);
                    iElementos.AppendChild(iElementoDetalle);
                    ...
                    ClXml.AgregarAtributo("Edad", GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Edad"], iElementoDetalle);
                    iElementos.AppendChild(iElementoDetalle);
                    ...
                    ClXml.AgregarAtributo("EstratoId", GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["EstratoId"], iElementoDetalle);
                    iElementos.AppendChild(iElementoDetalle);

                    
                }
                iInformacion.ChildNodes[1].AppendChild(iElementos);
                ClGestionRegistro.Insert_Inventario_Forestal(GestionId, iInformacion, Convert.ToInt32(TxtUsuarioId.Text));
            }
            if (GrdPoligono.Items.Count > 0)
            {
                ...
                String iPoligonoGML = "";
                string ErrorMapa = "";
                if (ClPoligono.Actualizar_Poligono(iInformacionPol, ref GestionId, ref iPoligonoGML, Convert.ToInt32(TxtUsuarioId.Text), ref ErrorMapa))
                {
                ...
                else
                {
                    ...
                    ClGestionRegistro.BorraGestion(GestionId);
                    return;
                }
            ...
            Session["Solicitante"] = LblSolicitante.Text;
            Response.Redirect("~/WebForms/Wfrm_Inicio.aspx?appel=" + HttpUtility.UrlEncode(ClUtilitarios.Encrypt("4", true)) + "&traite=" + HttpUtility.UrlEncode(ClUtilitarios.Encrypt(NUG, true)) + "");
        ...
        void VistaPrevia()
        {
            int TipoPersona = ClGestionRegistro.Get_Tipo_Persona_Fincas(1, Convert.ToInt32(TxtUsuarioId.Text));
            int NoRequisito = 1;
            ...
            row["TipoBosque"] = CboTipoBosque.Text;
            row["TotalForestal"] = ClGestionRegistro.Get_Sum_Area_Plantacion(Convert.ToInt32(TxtUsuarioId.Text), 1);
            row["TipoBosqueId"] = CboTipoBosque.SelectedValue;
            ...
            for (int i = 0; i < GrdInventario.Items.Count; i++)
            {
                ...
                rowArboles["Rodal"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Rodal"];
                rowArboles["ClaseDesarrollo"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["ClaseDesarrollo"];
                rowArboles["Nombre_Comun"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Especie"];
                rowArboles["Nombre_Cientifico"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["NomCientificoEspecie"];
                rowArboles["Densidad"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Densidad"];
                rowArboles["AreaBasal"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Area"];
                rowArboles["Edad"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Edad"];
                rowArboles["DAP"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Dap"];
                rowArboles["Altura"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Altura"];
                rowArboles["Estrato"] = GrdInventario.Items[i].OwnerTableView.DataKeyValues[i]["Estrato"];
            ...
            Session["Ds_Formulario_BosqueNatural"] = Ds_Formulario_BosqueNatural;
            RadWindow1.Title = "Vista Previa Insripción";
            Session["TipoReporte"] = "1";
            RadWindow1.NavigateUrl = "~/WeForms_Reportes/Wfrm_RepFormularioBosqueNatural.aspx?appel=" + HttpUtility.UrlEncode(ClUtilitarios.Encrypt("0", true)) + "&utilisateurid=" + HttpUtility.UrlEncode(ClUtilitarios.Encrypt(TxtUsuarioId.Text, true)) + "";
        ...
        bool Valida()
        {
            ...
            bool HayError = false;
            if ((CboProcedencia.Text == "") || (CboProcedencia.SelectedValue == ""))
            {
                if (LblMensaje.Text == "")
            ...
            if (ValidaIgualTipoPropietario(Convert.ToInt32(TxtUsuarioId.Text), ref MensajeDiferentiTipoProp, ref  ValidaMismosPropietarios, ref TipoPropietario) == false)
            {
                if (LblMensaje.Text == "")
            ...
            if (ValidaMismosPropietarios == true)
            {
                ...
                if (TempValidaMismosPropietarios(Convert.ToInt32(TxtUsuarioId.Text), TipoPropietario, ref MensajeMismosPropietarios) == true)
                {
                    if (LblMensaje.Text == "")
        ...
        bool ValidaDatosFincaPropietarios(ref string Mensaje) //Valida que tenga propietariios/nom emp
        {
            ...
            for (int i = 0; i < GrdInmuebles.Items.Count; i++)
            {
                if (ClGestionRegistro.TienePropietarioNomEmp_FincaRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(GrdInmuebles.Items[i].OwnerTableView.DataKeyValues[i]["InmuebleId"])) == 0)
                {
                    BtnEror.Visible = true;
        ...
        bool ValidaDatosFincaAreas(ref string Mensaje) //Valida areas fincas
        {
            ...
            for (int i = 0; i < GrdInmuebles.Items.Count; i++)
            {
                if (ClGestionRegistro.TieneAras_FincaRegistro(Convert.ToInt32(TxtUsuarioId.Text), Convert.ToInt32(GrdInmuebles.Items[i].OwnerTableView.DataKeyValues[i]["InmuebleId"])) == 0)
                {
                    BtnEror.Visible = true;
        ...
        void ChkConIncentivos_CheckedChanged(object sender, EventArgs e)
        {
            if (ChkConIncentivos.Checked == true)
            {
                ClUtilitarios.LlenaCombo(ClCatalogos.ListadoProcedencia(9), CboProcedencia, "ProcedenciaId", "Procedencia");
                ClUtilitarios.AgregarSeleccioneCombo(CboProcedencia, "Procedencia");
            }
            else
            {
        ...
        void AgregaEspecie()
        {
            ...
            if (CboTipoBosque.SelectedValue != "2")
            {
                rowNew["ClaseDesarrolloId"] = CboClaseDesarrollo.SelectedValue;
                rowNew["ClaseDesarrollo"] = CboClaseDesarrollo.Text;
            }
            else
            {
                rowNew["ClaseDesarrolloId"] = 0;
                rowNew["ClaseDesarrollo"] = "";
            }
            rowNew["EspecieId"] = CboEspecie.SelectedValue;
            rowNew["Especie"] = ClCatalogos.Get_Nombre_Comun_Especie(Convert.ToInt32(CboEspecie.SelectedValue));
            rowNew["NomCientificoEspecie"] = ClCatalogos.Get_Nombre_Cientifico_Especie(Convert.ToInt32(CboEspecie.SelectedValue));
            rowNew["Densidad"] = TxtDensidad.Text;
            rowNew["Area"] = TxtArea.Text;
            rowNew["Edad"] = TxtAnisEsta.Text;
            rowNew["Dap"] = TxtDap.Text;
            rowNew["Altura"] = TxtAltura.Text;
            if (CboTipoBosque.SelectedValue == "2")
            {
                rowNew["EstratoId"] = CboEstrato.SelectedValue;
                rowNew["Estrato"] = CboEstrato.Text;
            }
            else
            {
                rowNew["EstratoId"] = 0;
            ...
            if (GrdInmuebles.Items.Count > 1)
            {
                for (int i = 0; i < GrdInmuebles.Items.Count; i++)
                {
                    ...
                    else
                    {
                        string PrimerNombre = "";
                        string TempNombre = "";
                        DataSet Fincas = ClGestionRegistro.Get_Fincas_Completas(Convert.ToInt32(TxtUsuarioId.Text));
