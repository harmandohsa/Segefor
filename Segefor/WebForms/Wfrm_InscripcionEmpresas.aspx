<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="Wfrm_InscripcionEmpresas.aspx.cs" Inherits="SEGEFOR.WebForms.Wfrm_InscripcionEmpresas" %>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2><strong>FORMULARIO PARA INSCRIPCIÓN DE EMPRESAS FORESTALES</strong></h2>
                            </div>
                        </div>
                        ...
                        <div class="ibox-content" runat="server" id="DivDetCategoria" visible="false">
                             <div><label class="col-sm-2 control-label centradolabel">Tipo de Empresa Forestal:</label>
                                <div class="col-sm-8"><telerik:RadComboBox ID="CboTipoEmpresa" AutoPostBack="true" Width="100%" runat="server"></telerik:RadComboBox></div>
                            </div>
                        </div>
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox float-e-margins">
                        ...
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content">
                            <h3><b><asp:Label runat="server" Font-Bold="true" Text="Registro Mercantil"></asp:Label></b></h3>
                        ...
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content">
                            <div><label class="col-sm-1 control-label centradolabel">Horas / Turno:</label>
                            ...
                            <div><label class="col-sm-1 control-label centradolabel">Turno/día:</label>
                                <div class="col-sm-2"><asp:TextBox runat="server" ID="TxtTurnoDia"  Enabled="false" step="any" type="number" min="0"  CssClass="form-control"></asp:TextBox></div>
                            </div>
                            <div><label class="col-sm-1 control-label centradolabel">Días/Año:</label>
                        ...
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content">
                            <div><label class="col-sm-3 control-label centradolabel">Número de empleados fijos:</label>
                            ...
                            <div><label class="col-sm-3 control-label centradolabel">Número de empleados no fijos:</label>
                        ...
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content">
                            <h3><b><asp:Label runat="server" Font-Bold="true" Text="Ubicación de la empresa"></asp:Label>   </b></h3>
                        ...
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content">
                            <div><label class="col-sm-1 control-label centradolabel">Teléfono 1:</label>
                            ...
                            <div><label class="col-sm-1 control-label centradolabel">Teléfono 2:</label>
