<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="Wfrm_Inscripcion_Arboles_Frutales.aspx.cs" Inherits="SEGEFOR.WebForms.Wfrm_Inscripcion_Arboles_Frutales" %>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2><strong>FORMULARIO PARA INSCRIPCIÓN  DE PLANTACIONES DE ARBOLES FRUTALES</strong></h2>
                            </div>
                        </div>
                                                                ...
                                                                <div class="ibox-content">
                                                                    <div class="col-sm-9">
                                                                        <div class="alert  alert-success alert-dismissable" runat="server" id="Div1" visible="false">
                                                                            ...
                                                                            <asp:Label runat="server" ID="Label111" Font-Bold="true">Error</asp:Label>
                                                                        </div>
