<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Site1.Master" AutoEventWireup="true" CodeBehind="Wfrm_Inscripcion_SistemaAgroForestal.aspx.cs" Inherits="SEGEFOR.WebForms.Wfrm_Inscripcion_SistemaAgroForestal" %>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-title">
                                <h2><strong>FORMULARIO PARA INSCRIPCIÓN  DE SISTEMAS AGROFORESTALES</strong></h2>
                            </div>
                        </div>
                        ...
                        <div class="ibox-content">
                            <h3><strong>I.  TIPO DE ORIGEN DEL SISTEMA AGROFORESTAL</strong></h3>
                        </div>
                        <div class="ibox-content">
                             <div><label class="col-sm-2 control-label centradolabel">Sub Categoría:</label>
                                <div class="col-sm-8"><telerik:RadComboBox ID="CboCategoriaSAF" AutoPostBack="true" Width="100%" runat="server"></telerik:RadComboBox></div>
                                <div class="col-sm-1"><asp:CheckBox runat="server"  ID="ChkCategoriaSAF" AutoPostBack="true" Visible="false" Text="¿Con Incentivos?." /></div>
                            </div>
                        </div>
                        <div class="ibox-content">
                        ...
                        <div class="ibox-content">
                             <div>
                                 <div class="col-sm-2"><asp:CheckBox runat="server"  ID="ChkSinIncentivo" AutoPostBack="true"  Text="Sin Incentivos" /></div>
                                <div class="col-sm-2"><asp:CheckBox runat="server"  ID="ChkConIncentivos" AutoPostBack="true"  Text="Con Incentivos" /></div>
                            </div>
                        </div>
                        <div style="padding-bottom:2em;"></div>
                        <div class="ibox-content">
                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div id="collapseOne" class="panel-collapse collapse in">
                                                        <div class="panel-body">
                                                         ...
                                                         <div class="panel-body">
                                                            <div>
                                                                <label class="col-sm-3 control-label">Nombre Sistema Agroforestal:</label>
                                                                <div class="col-sm-7">
                                                                    <asp:TextBox runat="server" ID="TxtNombreSistema" Enabled="false"  CssClass="form-control"></asp:TextBox>	
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="panel-body">
                                                        ...
                                                        <div class="panel-body">
                                                            <div>
                                                                ...
                                                                <label class="col-sm-2 control-label">Distanciamiento</label>
                                                                <div class="col-sm-2">
                                                                     <asp:TextBox runat="server" ID="TxtDistancia" CssClass="form-control"></asp:TextBox>	
                                                                </div>
                                                        ...
                                                        <div class="panel-body">
                                                            <telerik:RadGrid runat="server" ID="GrdInventario" Skin="Telerik"
                                                                ...
                                                                <PagerStyle Mode="NumericPages" NextPageText="Siguiente" 
                                                                    ...
                                                                    PagerTextFormat="Change page: {4} &amp;nbsp;Pagina &lt;strong&gt;{0}&lt;/strong&gt; de &lt;strong&gt;{1}&lt;/strong&gt;, registros &lt;strong&gt;{2}&lt;/strong&gt; a &lt;strong&gt;{3}&lt;/strong&gt; de &lt;strong&gt;{5}&lt;/strong&gt;." 
                                                                    PageSizeLabelText="Regitros"/>
                                                                <MasterTableView Name="LabelsInventario" Caption="" DataKeyNames="EspecieId,Especie,CntArboles,Dap,Altura,Distancia,Volumen,YearEst" NoMasterRecordsText="No Hay Registros" ShowFooter="true">
                                                                    <Columns>
                                                                        ...
                                                                        <telerik:GridBoundColumn DataField="Distancia" UniqueName="Distancia" HeaderText="Distancia" HeaderStyle-Width="125px"></telerik:GridBoundColumn>
